...
def _extra_args(parser):
    ...
    parser.add_argument("--denoiser_type", type=str, default="mlp",
                        choices=["mlp", "mlp_ortho", "unet", "unet_vqc", "vqc_angle", "vqc_angle_delta", "vqc_angle_reupload", "vqc_qubit_cond"],
                        help="Denoiser architecture: mlp | mlp_ortho | unet | unet_vqc | vqc_angle | vqc_angle_delta | vqc_angle_reupload | vqc_qubit_cond")
